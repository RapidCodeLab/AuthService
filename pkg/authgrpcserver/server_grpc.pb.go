...
func (c *authClient) GetPublicKey(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/authgrpcserver.Auth/GetPublicKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) GetPublicKey(context.Context, *Empty) (*Response, error) {
...
func _Auth_GetPublicKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authgrpcserver.Auth/GetPublicKey",
	}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authgrpcserver.Auth",
